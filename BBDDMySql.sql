CREATE DATABASE ProyectoProgramacionBBDDMySql;

USE ProyectoProgramacionBBDDMySql;

/*Creación de tablas*/
CREATE TABLE fabricante
(
 CodFab INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 NomFab VARCHAR(100) NOT NULL
);
CREATE TABLE cpu
(
 CodCpu INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
(
 CodRefCpu INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 Precio FLOAT NOT NULL CHECK (Precio>0),
 Modelo VARCHAR(100) NOT NULL UNIQUE,
 Consumo FLOAT NOT NULL CHECK (Consumo>0),
...
CREATE TABLE gpu
(
 CodGpu INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 Precio FLOAT NOT NULL CHECK (Precio>0),
 Modelo VARCHAR(100) NOT NULL UNIQUE,
 Stock INT NOT NULL CHECK (Stock>=0),
...
(
 CodRefGpu INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 Modelo VARCHAR(100) NOT NULL UNIQUE,
...
(
 CodVent INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 Precio FLOAT NOT NULL CHECK (Precio>0),
 Modelo VARCHAR(100) NOT NULL UNIQUE,
 Consumo FLOAT NOT NULL CHECK (Consumo>0),
...
CREATE TABLE ram
(
 CodRam INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 Precio FLOAT NOT NULL CHECK (Precio>0),
 Modelo VARCHAR(100) NOT NULL UNIQUE,
...
(
 CodAlm INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 Precio FLOAT NOT NULL CHECK (Precio>0),
 Modelo VARCHAR(100) NOT NULL UNIQUE,
...
CREATE TABLE fuente
(
 CodFuen INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 Precio FLOAT NOT NULL CHECK (Precio>0),
 Modelo VARCHAR(100) NOT NULL UNIQUE,
 Stock INT NOT NULL CHECK (Stock>=0),
...
CREATE TABLE chasis
(
 CodCha INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 Precio FLOAT NOT NULL CHECK (Precio>0),
 Modelo VARCHAR(100) NOT NULL UNIQUE,
...
(
 CodPB INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 Precio FLOAT NOT NULL CHECK (Precio>0),
...
(
 CodOrd INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
(
 CodMon INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 Nombre VARCHAR(50) NOT NULL,
 Apellidos VARCHAR(100) NOT NULL,
 DNI CHAR(9) NOT NULL UNIQUE CHECK (CHAR_LENGTH(DNI) = 9 AND DNI REGEXP '^[0-9]{8}[A-Z]$'),
 FechaIni DATE NOT NULL DEFAULT CURRENT_DATE,
 Titulacion VARCHAR(100) NOT NULL
);
CREATE TABLE montaje
(
 CodMontaje INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
(
 CodSerTest INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 Nombre VARCHAR(50) NOT NULL UNIQUE,
 Estrellas FLOAT NOT NULL CHECK (Estrellas BETWEEN 1 AND 5)
);
CREATE TABLE testeo
(
 CodTest INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
(
 CodCar INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
 Fecha DATE NOT NULL DEFAULT CURRENT_DATE,
 ...
 Estado VARCHAR(50) NOT NULL DEFAULT 'compraNoRealizada',
 CodUsu INT NOT NULL,
...
(
 CodConCar INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
/*volver a hacer cerificacion de edad de usuario + check estado de carrito)*/

/*revisar fecha montaje*/